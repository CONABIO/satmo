...
FLAGS = {'CHL':['ATMFAIL','LAND','HILT','HISATZEN','STRAYLIGHT','CLDICE','COCCOLITH','LOWLW','CHLWARN',
                'CHLFAIL','NAVWARN','MAXAERITER','ATMWARN','HISOLZEN','NAVFAIL','FILTER','HIGLINT'],
         'RRS':['ATMFAIL','LAND','HILT','HISATZEN','STRAYLIGHT','CLDICE','COCCOLITH','LOWLW','CHLWARN',
                'CHLFAIL','NAVWARN','MAXAERITER','ATMWARN','HISOLZEN','NAVFAIL','FILTER','HIGLINT'],
         'FLH':['ATMFAIL','LAND','HILT','HISATZEN','STRAYLIGHT','CLDICE','COCCOLITH','LOWLW','CHLWARN',
                'CHLFAIL','NAVWARN','MAXAERITER','ATMWARN','HISOLZEN','NAVFAIL','FILTER','HIGLINT','PRODWARN','MODGLINT'],
         'PIC':['ATMFAIL','LAND','HISATZEN','STRAYLIGHT','CLDICE','LOWLW','NAVWARN','ATMWARN','HISOLZEN',
                'NAVFAIL','FILTER','HIGLINT'],
         'PAR':['LAND','NAVFAIL','FILTER','HIGLINT'],
         'POC':['ATMFAIL','LAND','HILT','HISATZEN','STRAYLIGHT','CLDICE','COCCOLITH','LOWLW','CHLWARN',
                'CHLFAIL','NAVWARN','MAXAERITER','ATMWARN','HISOLZEN','NAVFAIL','FILTER','HIGLINT'],
         'KD490':['ATMFAIL','LAND','HILT','HISATZEN','STRAYLIGHT','CLDICE','COCCOLITH','LOWLW','CHLWARN',
                'CHLFAIL','NAVWARN','MAXAERITER','ATMWARN','HISOLZEN','NAVFAIL','FILTER','HIGLINT'],
